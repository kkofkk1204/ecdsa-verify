...
const ContentComponent = () => {
  ...
  const onMetamaskSignClicked = async () => {
    ...
    var whitelist = ["0xb6456bEb1901bE751fcB49f284f160235476c5c2",
    "0x966bB9f8EB07a3E262567dbE7472FC01611EfEa0"]
   const signerAcc = "0xA0F2e71761Fb333C5639d47b54138a9B7b22Fc09"
    ...
    const flatSignature = await library.getSigner().signMessage(arrayifyMessage)
		signature_code[whitelist[i]] = flatSignature;
    }
    console.log(signature_code)
  }
